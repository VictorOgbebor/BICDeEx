...
const showForm = (props) => {
  ...
  return(
    <Tabs defaultActiveKey="buy" className="bg-warning text-dark">
      ...
      <Tab eventKey="buy" title="Buy" className="bg-dark">
          ...
          <div className="form-group small">
            <label>Buy Amount (BIC)</label>
            <div className="input-group">
              <input
                type="text"
                className="form-control form-control-sm bg-light text-white"
